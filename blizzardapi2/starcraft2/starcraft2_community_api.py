...
class Starcraft2CommunityApi(Api):
    ...
    def get_metadata(self, region: str, locale: str, region_id: int, realm_id: int, profile_id: int) -> Dict[str, Any]:
        """Returns metadata for an individual's profile."""
        resource = f"/sc2/metadata/profile/{region_id}/{realm_id}/{profile_id}"
        query_params = {"locale": locale}
        return super().get_resource(resource, region, query_params)

    def get_profile(self, region: str, locale: str, region_id: int, realm_id: int, profile_id: int, **query_params: Any) -> Dict[str, Any]:
        """Returns data about an individual SC2 profile."""
        resource = f"/sc2/profile/{region_id}/{realm_id}/{profile_id}"
        query_params["locale"] = locale
        return super().get_resource(resource, region, query_params)

    def get_ladder_summary(self, region: str, locale: str, region_id: int, realm_id: int, profile_id: int) -> Dict[str, Any]:
        """Returns a ladder summary for an individual SC2 profile."""
        resource = f"/sc2/profile/{region_id}/{realm_id}/{profile_id}/ladder/summary"
        query_params = {"locale": locale}
        return super().get_resource(resource, region, query_params)

    def get_ladder(self, region: str, locale: str, region_id: int, realm_id: int, profile_id: int, ladder_id: int, **query_params: Any) -> Dict[str, Any]:
    ...
    def get_grandmaster_leaderboard(self, region: str, locale: str, region_id: int) -> Dict[str, Any]:
