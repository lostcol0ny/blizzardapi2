...
class Diablo3CommunityApi(Api):
    ...
    def get_recipe(self, region: str, locale: str, artisan_slug: str, recipe_slug: str) -> Dict[str, Any]:
    ...
    def get_api_skill(self, region: str, locale: str, class_slug: str, skill_slug: str) -> Dict[str, Any]:
    ...
    def get_api_hero(self, region: str, locale: str, account_id: str, hero_id: int) -> Dict[str, Any]:
        """Return a single hero."""
        resource = f"/d3/profile/{account_id}/hero/{hero_id}"
        query_params = {"locale": locale}
        return super().get_resource(resource, region, query_params)

    def get_api_detailed_hero_items(self, region: str, locale: str, account_id: str, hero_id: int) -> Dict[str, Any]:
        """Return a list of items for the specified hero."""
        resource = f"/d3/profile/{account_id}/hero/{hero_id}/items"
        query_params = {"locale": locale}
        return super().get_resource(resource, region, query_params)

    def get_api_detailed_follower_items(self, region: str, locale: str, account_id: str, hero_id: int) -> Dict[str, Any]:
        """Return a single item by item slug and ID."""
